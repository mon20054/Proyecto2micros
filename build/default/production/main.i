...
void __attribute__((picinterrupt(("")))) isr (void){
    if(PORTBbits.RB7){
        if(PIR1bits.ADIF){
            if(ADCON0bits.CHS == 0){
                CCPR_servo1 = map(ADRESH, 0, 255, 25, 151);
            }
            else if(ADCON0bits.CHS == 1){
                CCPR_servo2 = map(ADRESH, 0, 255, 25, 151);

            }
            else if(ADCON0bits.CHS == 2){
                CCPR_servo3 = map(ADRESH, 0, 255, 25, 151);
                CCPR_servo3 = (CCPR_servo3 & 0b11111100) + 0b10;
            }
            else if(ADCON0bits.CHS == 3){
                CCPR_servo4 = map(ADRESH, 0, 255, 25, 0b1011000);
        ...
        if(PIR1bits.SSPIF){
            val_temp = SSPBUF;
            bandera_CCPR = val_temp & 0b00000011;
            val_temp = val_temp&0b11111100;

            if (bandera_CCPR == 0b00000010){
                CCPR1L = (uint8_t)(val_temp>>2);
                CCP1CONbits.DC1B = val_temp & 0b11;
            }

            else if(bandera_CCPR == 0b00000011){
                CCPR2L = (uint8_t)(val_temp>>2);
                CCP2CONbits.DC2B0 = val_temp & 0b1;
        ...
        if (PORTBbits.RB7){
            if (modo == 1){
                ...
                if(CCPR_servo1 != old_CCPR_servo1){
                    CCPR1L = (uint8_t)(CCPR_servo1>>2);
                    CCP1CONbits.DC1B = CCPR_servo1 & 0b11;
                    old_CCPR_servo1 = CCPR_servo1;
                }

                if(CCPR_servo2 != old_CCPR_servo2){
                    CCPR2L = (uint8_t)(CCPR_servo2>>2);
                    CCP2CONbits.DC2B0 = CCPR_servo2 & 0b1;
                    CCP2CONbits.DC2B1 = CCPR_servo2>>1 & 0b1;
                    old_CCPR_servo2 = CCPR_servo2;
                }
                ...
                if(CCPR_servo3 != old_CCPR_servo3){
                    ...
                    old_CCPR_servo3 = CCPR_servo3;
                }
                if(CCPR_servo4 != old_CCPR_servo4){
                    SSPBUF = CCPR_servo4;
                    while(!SSPSTATbits.BF){}
                    old_CCPR_servo4 = CCPR_servo4;
                }
            }
            else if (modo == 2){
                ...
                bandera_serial = (serial_temp & 0x03);

                if (bandera_serial == 0){
                    serial_temp3 = serial_temp3&0b11111100;
                    CCPR_servo1 = map(serial_temp3, 0, 0b1100000, 25, 151);
                    CCPR1L = (uint8_t)(CCPR_servo1>>2);
                    CCP1CONbits.DC1B = CCPR_servo1 & 0b11;
                }

                else if(bandera_serial == 1){
                    serial_temp3 = serial_temp3&0b11111100;
                    CCPR_servo2 = map(serial_temp3, 0, 0b1100000, 25, 151);
                    CCPR2L = (uint8_t)(CCPR_servo2>>2);
                    CCP2CONbits.DC2B0 = CCPR_servo2 & 0b1;
                    CCP2CONbits.DC2B1 = CCPR_servo2>>1 & 0b1;
                }
                    ...
                    CCPR_servo3 = (map(serial_temp3, 0, 0b1100011, 25, 151) & 0xFC) + 0b10;
                    ...
                    CCPR_servo4 = (map(serial_temp3, 0, 0b1100011, 25, 0b1011000) & 0xFC) + 0b11;
                    SSPBUF = CCPR_servo4;
                    while(!SSPSTATbits.BF){}
                }
                ...
                if (bandera_read_p1 == 1){
                    CCPR_temp = read_EEPROM(1);
                    CCPR1L = (uint8_t)(CCPR_temp>>2);
                    CCP1CONbits.DC1B = CCPR_temp & 0b11;
                    _delay((unsigned long)((1)*(1000000/4000.0)));
                    CCPR_temp = read_EEPROM(2);
                    CCPR2L = (uint8_t)(CCPR_temp>>2);
                    CCP2CONbits.DC2B0 = CCPR_temp & 0b1;
                    CCP2CONbits.DC2B1 = CCPR_temp>>1 & 0b1;
                    _delay((unsigned long)((1)*(1000000/4000.0)));
                    CCPR_temp = read_EEPROM(3);
                    SSPBUF = (CCPR_temp & 0b11111100) + 0b10;
                    while(!SSPSTATbits.BF){}
                    _delay((unsigned long)((1)*(1000000/4000.0)));
                    CCPR_temp = read_EEPROM(4);
                    SSPBUF = (CCPR_temp & 0b11111100) + 0b11;
                    while(!SSPSTATbits.BF){}
                    _delay((unsigned long)((1)*(1000000/4000.0)));
                    bandera_read_p1 = 0;
                }
                ...
                if (bandera_read_p2 == 1){
                    CCPR_temp = read_EEPROM(5);
                    CCPR1L = (uint8_t)(CCPR_temp>>2);
                    CCP1CONbits.DC1B = CCPR_temp & 0b11;
                    _delay((unsigned long)((1)*(1000000/4000.0)));
                    CCPR_temp = read_EEPROM(6);
                    CCPR2L = (uint8_t)(CCPR_temp>>2);
                    CCP2CONbits.DC2B0 = CCPR_temp & 0b1;
                    CCP2CONbits.DC2B1 = CCPR_temp>>1 & 0b1;
                    _delay((unsigned long)((1)*(1000000/4000.0)));
                    CCPR_temp = read_EEPROM(7);
                    SSPBUF = (CCPR_temp & 0b11111100) + 0b10;
                    while(!SSPSTATbits.BF){}
                    _delay((unsigned long)((1)*(1000000/4000.0)));
                    CCPR_temp = read_EEPROM(8);
                    SSPBUF = (CCPR_temp & 0b11111100) + 0b11;
                    while(!SSPSTATbits.BF){}
                    _delay((unsigned long)((1)*(1000000/4000.0)));
                    bandera_read_p2 = 0;
            ...
            if (bandera_write_p1 == 1){
                write_EEPROM(1,CCPR_servo1);
                _delay((unsigned long)((10)*(1000000/4000.0)));
                write_EEPROM(2,CCPR_servo2);
                _delay((unsigned long)((10)*(1000000/4000.0)));
                write_EEPROM(3,CCPR_servo3);
                _delay((unsigned long)((10)*(1000000/4000.0)));
                write_EEPROM(4,CCPR_servo4);
                _delay((unsigned long)((10)*(1000000/4000.0)));
                bandera_write_p1 = 0;
            }
            ...
            if (bandera_write_p2 == 1){
                write_EEPROM(5,CCPR_servo1);
                _delay((unsigned long)((10)*(1000000/4000.0)));
                write_EEPROM(6,CCPR_servo2);
                _delay((unsigned long)((10)*(1000000/4000.0)));
                write_EEPROM(7,CCPR_servo3);
                _delay((unsigned long)((10)*(1000000/4000.0)));
                write_EEPROM(8,CCPR_servo4);
                _delay((unsigned long)((10)*(1000000/4000.0)));
                bandera_write_p2 = 0;
            }
        }
